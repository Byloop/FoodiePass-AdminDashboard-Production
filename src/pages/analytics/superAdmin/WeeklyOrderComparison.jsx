import { WeeklyComparisonBarChart } from '../../../component/atoms/WeeklyComparisonBarChart';
import { ChevronSharpIcon } from '../../../assets/globals/icons';

export function WeeklyOrderComparison() {
  return (
    <div
    ...
    >
      <div className="flex items-center justify-between">
        <h5 className="text-blue font-semibold">Order Comparison</h5>
